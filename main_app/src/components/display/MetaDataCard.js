  ...
  return (
    <Grid container maxWidth="95%" style={{ margin: "10px auto" }}>
      {Object.keys(props.meta).map((k, i) =>(
        <Grid item container xs={12} md={4} style={{ margin:"10px auto"}}>
            <div class="card" style={{width:"85%", border:"1px solid #d8dadd", margin:"10px auto", padding:"10px", borderRadius:"10px"}}>
